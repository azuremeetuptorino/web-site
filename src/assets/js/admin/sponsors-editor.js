...
export const sponsorsEditor = createCollectionEditor({
    ...
    preview(row, { field, preview, value }) {
        ...
        // L'etichetta della fascia si prende dal <select>: una mappa a parte
        // sarebbe una seconda lista da tenere allineata.
